...
Theorem map_f : forall U U2 (v : U) (l : list U) (f : U -> U2),
...
Proof.
  ...
  induction H0.
  assert (H2 : (from_tr U n r = from_tr U n r1) /\ (to_tr U n r1) =
               (from_tr U n r2) /\ (to_tr U n r = to_tr U n r2)).
