...
Module Intersection.
  ...
  Section CanonicalStructureTer.
    ...
    Section ChoiceTypeTer.
      ...
      Lemma cancelterK: cancel from_ter to_ter.
      Proof. by intros t; destruct t. Qed.
      
      Global Definition ter_choiceMixin := CanChoiceMixin cancelterK.
    ...
    Section CountTypeTer.
      ...
      Global Definition ter_countMixin := CanCountMixin (@cancelterK T).
