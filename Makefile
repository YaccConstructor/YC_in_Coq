...
# coq_makefile -f _CoqProject ./cfg/Chomsky.v ./cfg/Dec_Empty.v ./cfg/Base.v ./cfg/Lists.v ./cfg/ElimE.v ./cfg/Dec_Word.v ./cfg/Binarize.v ./cfg/Derivation.v ./cfg/ElimU.v ./cfg/Definitions.v ./cfg/Symbols.v ./cfg/Separate.v ./cfg/Inlining.v ./int/Base2.v ./int/Union.v ./int/Intersection.v ./int/ChomskyInduction.v ./int/DFA.v ./aut/regexp.v ./aut/myhill_nerode.v ./aut/re_fa.v ./aut/transitive_closure.v ./aut/re_standard.v ./aut/automata.v ./aut/misc.v ./aut/glue.v ./aut/tactics.v ./aut/base.v -o Makefile 
#
...
validate: $(VOFILES)
	$(COQCHK) $(COQCHKFLAGS) $(COQCHKLIBS) $(addprefix rt., $(subst /,., $(^:.vo=)))
